...
try:
    # --- 1. DATA INGESTION (Your existing code) ---
    ...
    sns.countplot(data=df, x='OrderStatus', ax=axes[0], hue='OrderStatus', palette='mako', legend=False, order=df['OrderStatus'].value_counts().index)
